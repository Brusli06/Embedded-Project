...
- {id: SCG.PLL1M_MULT.scale, value: '209584128'}
...
- {id: SYSCON.CTIMERCLKSEL1.sel, value: SYSCON.pll1_clk0}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll1Setup = {
        ...
        .pllsscg = {(SCG_SPLLSSCG0_SS_MDIV_LSB(209584128U)),((SCG0->SPLLSSCG1 & ~SCG_SPLLSSCG1_SS_PD_MASK) | SCG_SPLLSSCG1_SS_MDIV_MSB(0U) | (uint32_t)(kSS_MF_512) | (uint32_t)(kSS_MR_K0) | (uint32_t)(kSS_MC_NOC) | SCG_SPLLSSCG1_SEL_SS_MDIV_MASK)},
        .pllRate = 149906250U
    };
    ...
    CLOCK_AttachClk(kPLL1_CLK0_to_CTIMER1);                 /*!< Switch CTIMER1 to PLL1_CLK0 */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivPLL1Clk0, 1U);           /*!< Set PLL1CLK0DIV divider to value 1 */
