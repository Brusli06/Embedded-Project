...
#define GPIO3_INT_1_IRQN GPIO31_IRQn
/* GPIO3 interrupt handler identifier. */
#define GPIO3_INT_1_IRQHANDLER GPIO31_IRQHandler
...
/* Command 2 - TH */
#define ADC0_TH 2U
/* Command 3 - LIGHT_SENSOR */
#define ADC0_LIGHT_SENSOR 3U
/* Command 1 - POT */
#define ADC0_POT 1U
/* Definition of peripheral ID */
...
extern void ctimer1_match_callback(uint32_t flags);
extern ctimer_callback_t CTIMER0_callback[];
  /* Single callback function declaration */
extern void ctimer2_match_callback(uint32_t flags);
